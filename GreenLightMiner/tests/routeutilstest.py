...
from GreenLightMiner.pointxyz import PointXyz, PointXyzList
...
class RouteUtilsTest_advance_candidates(unittest.TestCase):
    ...
    def test_all_advanced(self):
        rt0: PointXyzList = [PointXyz(0, 0, 0), PointXyz(1, 0, 0), PointXyz(2, 0, 0), PointXyz(3, 0, 0)]
        rt1: PointXyzList = [PointXyz(0.1, 0, 0), PointXyz(1.1, 0.1, 0), PointXyz(2.1, 0.2, 0), PointXyz(3.1, 0.3, 0)]
    ...
    def test_one_advanced(self):
        rt0: PointXyzList = [PointXyz(0, 0, 0), PointXyz(1.1, 0, 0), PointXyz(2, 0, 0), PointXyz(3, 0, 0)]
        rt1: PointXyzList = [PointXyz(0.1, 0, 0), PointXyz(0.9, 0.1, 0), PointXyz(3.1, 0.2, 0), PointXyz(4.1, 0.3, 0)]
        candidates = [RouteCandidateInfo(rt0[1], 1, 0), RouteCandidateInfo(rt1[1], 1, 1)]
    ...
    def test_all_removed(self):
        rt0: PointXyzList = [PointXyz(0, 0, 0), PointXyz(1, 0, 0), PointXyz(2, 0, 0), PointXyz(30, 0, 0)]
        rt1: PointXyzList = [PointXyz(0.1, 0, 0), PointXyz(1.1, 0.1, 0), PointXyz(3.1, 0.2, 0), PointXyz(40.1, 0.3, 0)]
        candidates = [RouteCandidateInfo(rt0[1], 1, 0), RouteCandidateInfo(rt1[1], 1, 1)]
...
class RouteUtilsTest_remove_not_same_direction(unittest.TestCase):
    ...
    def test_candidate_id_0(self):
        rt0: PointXyzList = [PointXyz(0, 0, 0), PointXyz(1, 0, 0), PointXyz(2, 0, 0), PointXyz(3, 0, 0)]
        rt1: PointXyzList = [PointXyz(0, 0, 0), PointXyz(1, 1, 0), PointXyz(2, 2, 0), PointXyz(3, 3, 0)]
